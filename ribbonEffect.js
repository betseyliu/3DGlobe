...
const ribbonhaderhader = require('./RibbonShaders.glsl')

var defaultOptions = {

    "segments": 50, 
    "poolSize": 50,
    "texture": THREE.ImageUtils.loadTexture('./resources/textures/' + "light_dot.png") //impact_32x32.jpg  dot_8x8.png
};
        ...
        fill: function (){
            ...
            for ( var i = 0; i < _this.poolSize; i++ ){
                ...
                var material = new THREE.ShaderMaterial({
                    ...
                    vertexShader:   ShaderMatch("ribbon_vs", ribbonhaderhader)[0],
                    fragmentShader: ShaderMatch("ribbon_fs", ribbonhaderhader)[0],
